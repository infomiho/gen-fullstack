...
3. Plan the page structure and routes
4. Plan the API endpoints
5. Implement server routes with proper error handling
6. Create React components with proper state management and routing
...
- Example: updatePackageJson({ target: "client", dependencies: { "zod": "^3.0.0" } })
