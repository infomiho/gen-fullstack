...
export function CapabilitiesList({ capabilityConfig }: CapabilitiesListProps) {
  return (
    <div className="space-y-2">
      ...
      <div
        className={`flex items-center gap-2 text-sm ${capabilityConfig.planning ? 'text-foreground' : 'text-muted-foreground line-through'}`}
      >
        <CAPABILITY_METADATA.planning.icon
          className={`w-4 h-4 ${capabilityConfig.planning ? CAPABILITY_METADATA.planning.iconColor : 'text-muted-foreground'} flex-shrink-0`}
        />
      ...
      <div
        className={`flex items-center gap-2 text-sm ${capabilityConfig.inputMode === 'template' ? 'text-foreground' : 'text-muted-foreground line-through'}`}
      >
        <CAPABILITY_METADATA.template.icon
          className={`w-4 h-4 ${capabilityConfig.inputMode === 'template' ? CAPABILITY_METADATA.template.iconColor : 'text-muted-foreground'} flex-shrink-0`}
        />
      ...
      <div
        className={`flex items-center gap-2 text-sm ${capabilityConfig.compilerChecks ? 'text-foreground' : 'text-muted-foreground line-through'}`}
      >
        <CAPABILITY_METADATA.compiler.icon
          className={`w-4 h-4 ${capabilityConfig.compilerChecks ? CAPABILITY_METADATA.compiler.iconColor : 'text-muted-foreground'} flex-shrink-0`}
        />
      ...
      <div
        className={`flex items-center gap-2 text-sm ${capabilityConfig.buildingBlocks ? 'text-foreground' : 'text-muted-foreground line-through'}`}
      >
        <CAPABILITY_METADATA.buildingBlocks.icon
          className={`w-4 h-4 ${capabilityConfig.buildingBlocks ? CAPABILITY_METADATA.buildingBlocks.iconColor : 'text-muted-foreground'} flex-shrink-0`}
        />
